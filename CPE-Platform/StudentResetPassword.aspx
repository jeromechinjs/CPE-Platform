...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div>
		...
		<asp:RequiredFieldValidator ID="RequiredFieldValidatorStuNewPassword" Text="*" ForeColor="Red" runat="server" ErrorMessage="New Password is required" ControlToValidate="txtNewPassword"></asp:RequiredFieldValidator><br />
