...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div>
		...
		<asp:RequiredFieldValidator ID="RequiredFieldValidatorStudentID" Text="*" runat="server" ErrorMessage="Student ID is required" ForeColor="Red" ControlToValidate="txtStudentID"></asp:RequiredFieldValidator><br />
		...
		<asp:RequiredFieldValidator ID="RequiredFieldValidatorStudentPassword" Text="*" runat="server" ErrorMessage="Password is required" ForeColor="Red" ControlToValidate="txtStudentPassword"></asp:RequiredFieldValidator><br /><br />
