						...
						<div class="card-body p-2 text-center">
							<div class="mb-md-5 mt-md-4 pb-2">
								...
								<div class="mb-md-2 mt-md-2 pb-2">
									<asp:Button ID="btnStaffLogin" class="btn btn-outline-primary btn-lg px-6" runat="server" Text="Login As CPE Staff" OnClick="btnStaffLogin_Click" />
									<br />
								</div>
								<div class="mb-md-4 mt-md-4">
									<asp:Button ID="btnStudentLogin" class="btn btn-outline-primary btn-lg px-6" runat="server" Text="Login As Student" OnClick="btnStudentLogin_Click" />
								</div>
