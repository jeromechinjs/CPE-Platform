		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				if (Session["StudentID"] != null)
				{
					...
					string query = "SELECT DISTINCT PaymentID, P.BillRefNo, Description, TotalPrice, Invoice, PaymentDate FROM Payment P, CPE_Registration R WHERE R.StudentID =@StudentID AND P.BillRefNo = R.BillRefNo ORDER BY PaymentID DESC";
