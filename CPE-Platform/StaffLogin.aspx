				...
				<div class="card bg-dark text-white" style="border-radius: 1rem;">
					<div class="card-body p-6 text-center">
						...
						<div class="mb-md-5 mt-md-4 pb-5">
							...
							<p class="small mb-3 pb-lg-2">
								<asp:HyperLink class="text-white-50" ID="navForgetPassword" NavigateUrl="~/Public/StaffForgetPassword.aspx" runat="server">Forgot password?</asp:HyperLink>
							</p>
						...
						<div>
							<p class="mb-4">
								...
								<asp:HyperLink ID="navRegisterStudent" class="text-white-50 fw-bold" NavigateUrl="~/Public/StaffRegisterInfo.aspx" runat="server">Sign Up</asp:HyperLink>
							</p>
						</div>
