		...
		<div class="container py-5 h-100">
			<div class="row d-flex justify-content-center align-items-center h-50">
				<div class="col-12 col-md-8 col-lg-6 col-xl-4">
					<h2 class="text-lg-center mb-4">TAR UMT Staff Intranet</h2>
					<div class="card bg-light text-black" style="border-radius: 1rem;">
						<div class="card-body p-6 text-center">

							<div class="mb-md-5 mt-md-4 pb-2">
								<p class="text-black-70 mb-5">Please enter your login and password!</p>
								<div>
								...
								<p class="small mb-3 pb-lg-2">
									<asp:HyperLink class="text-black-50 custom-link" ID="navForgetPassword" NavigateUrl="~/Public/StaffForgetPassword.aspx" runat="server">Forgot password?</asp:HyperLink>
								</p>

								<asp:Button ID="btnStaffLogin" class="btn btn-outline-dark btn-lg px-5" runat="server" Text="Login" OnClick="btnStaffLogin_Click"></asp:Button>
							...
							<div>
								...
								<asp:HyperLink ID="navRegisterStudent" class="text-black-50 fw-bold custom-link" NavigateUrl="~/Public/StaffRegisterInfo.aspx" runat="server">Sign Up</asp:HyperLink>
								</p>
							</div>
